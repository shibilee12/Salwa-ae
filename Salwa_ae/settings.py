"""
Django settings for Salwa_ae project.
...
SECRET_KEY = 'django-insecure--__j#(p(g+!melv@kq_uw0olcdu2alrj2)(b-nt&@v@8q4y+h='
...
WSGI_APPLICATION = 'Salwa_ae.wsgi.application'
